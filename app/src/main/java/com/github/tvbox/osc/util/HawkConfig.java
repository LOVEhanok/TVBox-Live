...
public class HawkConfig {
    ...
    public static final String LIVE_LAST_REFRESH_TIME = "live_last_refresh_time";
    public static final String LIVE_FIRST_DISCOVERY_DONE = "live_first_discovery_done";
